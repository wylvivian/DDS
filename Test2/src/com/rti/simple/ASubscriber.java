...
/* Introduction: this class is to subscribe the "topic A" data and write read data into a csv file*/

//DDS package
package com.rti.simple;

//java library for writing csv
...
public class ASubscriber extends DataReaderAdapter {
    ...
    public static final void main(String[] args) {
        ...
        //subscriber of "Topic A" needs to subscribe "Topic A"
    ...
    //create a array list to store the vehicle data 
        ...
        for (;;) {
            try {
                ...
                if (info.valid_data) {
                    ...
                    String[] sampleList= sample.split("/");//split the long string data to a long string array
                    for (int x=0; x<sampleList.length;x++) {//go through each vehicle
                    ...
                    Vehicles.add(car);//add the vehicle into the vehicle array list
                    }
                    
                    System.out.println("###"+sample);//output the data in console
                    try {
                    	WriteCSV.write(Vehicles, "TopicA.csv");// pass the vehicle to write into a csv file
