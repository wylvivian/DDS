...
/**
* A sequence of cft instances.
*/
public final class cftSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public cftSeq (int initialMaximum) {
        super(cft.class, initialMaximum);
    }

    public cftSeq (Collection elements) {
        super(cft.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' cft objects (beyond the original size of this object)
