...
public class cftTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "cft";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final cftTypeSupport _singleton
    = new cftTypeSupport();
    ...
    */
    public static cftTypeSupport get_instance() {
        return _singleton;
    }

    public static cftTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return cftTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>cft</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        cft typedDst = (cft) destination;
        cft typedSrc = (cft) source;
    ...
    int mask) {
        return new cftDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new cftDataReader(native_reader, listener, mask, this);   
    ...
    protected cftTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,cftTypeCode.VALUE,cft.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected cftTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,cftTypeCode.VALUE,cft.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
