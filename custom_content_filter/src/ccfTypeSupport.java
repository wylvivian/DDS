...
public class ccfTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ccf";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ccfTypeSupport _singleton
    = new ccfTypeSupport();
    ...
    */
    public static ccfTypeSupport get_instance() {
        return _singleton;
    }

    public static ccfTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ccfTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ccf</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ccf typedDst = (ccf) destination;
        ccf typedSrc = (ccf) source;
    ...
    int mask) {
        return new ccfDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ccfDataReader(native_reader, listener, mask, this);   
    ...
    protected ccfTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ccfTypeCode.VALUE,ccf.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ccfTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ccfTypeCode.VALUE,ccf.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
