...
/**
* A sequence of ccf instances.
*/
public final class ccfSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ccfSeq (int initialMaximum) {
        super(ccf.class, initialMaximum);
    }

    public ccfSeq (Collection elements) {
        super(ccf.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' ccf objects (beyond the original size of this object)
